...
public class AbstractCanalClient {
    ...
    public AbstractCanalClient(String destination, CanalConnector connector, Producer<String, String> kafkaProducer) {
                ...
                while (running) {
                    ...
                    try {
                        ...
                        if (batchId == -1 || size == 0) {
                            ...
                            //kafkaProducer.send(new ProducerRecord<>("canal", gson.toJson(message)));
                        }
        ...
        for (Entry entry : entrys) {
            ...
            if (entry.getEntryType() == EntryType.ROWDATA) {
                ...
                if (eventType == EventType.QUERY || rowChage.getIsDdl()) {
                    ...
                    logger.info(" schema name ----> " +  rowChage.getDdlSchemaName() + SEP);
                    continue;
                }
